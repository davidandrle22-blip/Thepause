...
export function ShareButton({ certificateId, name }: { certificateId: string; name: string }) {
  ...
  return (
    <button
      onClick={handleShare}
      className="mt-6 w-full flex items-center justify-center gap-2 px-4 py-3 bg-teal-600 hover:bg-teal-700 text-white rounded-xl font-medium transition-colors"
    >
